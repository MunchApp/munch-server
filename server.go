...
func main() {
	...
	router.HandleFunc("/review/{reviewID}", routes.GetReviewHandler).Methods("GET")
	...
	router.HandleFunc("/user/favorite/{foodTruckID}", routes.PutFavoriteHandler).Methods("PUT")
